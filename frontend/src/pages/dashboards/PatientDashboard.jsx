...
export default function PatientDashboard() {
  ...
  const actions = [
    { icon: '🔍', title: 'Find Doctor', desc: 'Search by speciality or location', href: '/patient/doctors' },
    { icon: '📅', title: 'My Appointments', desc: 'View and manage bookings', href: '/patient/appointments' },
    { icon: '💊', title: 'Prescriptions', desc: 'Access digital prescriptions', href: '/patient/prescriptions' },
    { icon: '📋', title: 'Medical Records', desc: 'Your health documents', href: '/patient/records' },
  ];
